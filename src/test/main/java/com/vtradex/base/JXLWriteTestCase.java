...
public class JXLWriteTestCase {
	
	private String filename;
	private WritableWorkbook workbook;

	public JXLWriteTestCase(String fn) {
		this.filename = fn;
	}
	
	public static void main(String[] args) {
		JXLWriteTestCase d = new JXLWriteTestCase("a.xls");
		try {
			d.write();
	...
	private void writeNumberFormatSheet(WritableSheet s) throws WriteException {
		...
		n = new Number(2, 0, -3.1415926535D);
		s.addCell(n);
		...
		n = new Number(1, 1, 3.1415926535D, cf1);
		s.addCell(n);

		n = new Number(2, 1, -3.1415926535D, cf1);
		s.addCell(n);
		...
		n = new Number(1, 2, 3.1415926535D, cf2);
		s.addCell(n);

		n = new Number(2, 2, -3.1415926535D, cf2);
		s.addCell(n);
		...
		n = new Number(1, 3, 3.1415926535D, dp3cell);
		s.addCell(n);

		n = new Number(2, 3, -3.1415926535D, dp3cell);
		s.addCell(n);
		...
		n = new Number(1, 4, 3.1415926535D, pounddp2cell);
		s.addCell(n);

		n = new Number(2, 4, -3.1415926535D, pounddp2cell);
		s.addCell(n);
		...
		n = new Number(1, 5, 3.1415926535D, textdp4cell);
		s.addCell(n);

		n = new Number(2, 5, -3.1415926535D, textdp4cell);
		s.addCell(n);

		l = new Label(4, 0, "+/- Bilko default format");
		s.addCell(l);
		n = new Number(5, 0, 15042699.0D);
		s.addCell(n);
		n = new Number(6, 0, -15042699.0D);
		s.addCell(n);

		l = new Label(4, 1, "+/- Bilko float format");
		s.addCell(l);
		WritableCellFormat cfi1 = new WritableCellFormat(NumberFormats.FLOAT);
		n = new Number(5, 1, 15042699.0D, cfi1);
		s.addCell(n);
		n = new Number(6, 1, -15042699.0D, cfi1);
		s.addCell(n);
		...
		n = new Number(5, 2, 15042699.0D, cfi2);
		s.addCell(n);
		n = new Number(6, 2, -15042699.0D, cfi2);
		s.addCell(n);
		...
		n = new Number(5, 3, 15042699.01D, cfi3);
		s.addCell(n);
		n = new Number(6, 3, -15042699.01D, cfi3);
		s.addCell(n);
		...
		n = new Number(5, 4, 15042699.0D, cfi4);
		s.addCell(n);
		n = new Number(6, 4, -15042699.0D, cfi4);
		s.addCell(n);
		...
		n = new Number(5, 5, 15042699.0D, cfi5);
		s.addCell(n);
		n = new Number(6, 5, -15042699.0D, cfi5);
		s.addCell(n);
		...
		n = new Number(5, 6, 15042699.0D, edp3Cell);
		s.addCell(n);
		n = new Number(6, 6, -15042699.0D, edp3Cell);
		s.addCell(n);
		...
		n = new Number(5, 7, 15042699.0D, negbrackscell);
		s.addCell(n);
		n = new Number(6, 7, -15042699.0D, negbrackscell);
		s.addCell(n);
		...
		n = new Number(5, 8, 15042699.0D, negbrackscell2);
		s.addCell(n);
		n = new Number(6, 8, -15042699.0D, negbrackscell2);
		s.addCell(n);
		...
		n = new Number(5, 9, 3.14159265D, cuspercentf);
		s.addCell(n);
		...
		s.addCell(l);
		n = new Number(1, 12, 17.0D, WritableWorkbook.HIDDEN_STYLE);
		s.addCell(n);
		...
		n = new Number(5, 21, 12345.0D, poundFormat);
		s.addCell(n);
		...
		n = new Number(5, 22, 12345.0D, euroPrefixFormat);
		s.addCell(n);
		...
		n = new Number(5, 23, 12345.0D, euroSuffixFormat);
		s.addCell(n);
		...
		n = new Number(5, 24, 12345.0D, dollarFormat);
		s.addCell(n);
		...
		n = new Number(5, 25, 12345.0D, japaneseYenFormat);
		s.addCell(n);
		...
		n = new Number(5, 32, 3.18279D, fraction1digitformat);
		s.addCell(n);
		...
		n = new Number(5, 33, 3.18279D, fraction2digitformat);
		s.addCell(n);
		...
		n = new Number(5, 34, 3.18927D, fraction3digitformat1);
		s.addCell(n);
		...
		n = new Number(5, 35, 3.18927D, fraction3digitformat2);
		s.addCell(n);
	...
	private void writeDateFormatSheet(WritableSheet s) throws WriteException {
		...
		l = new Label(0, 25, "Battle of Hastings " + sdf.format(date14), wrappedText);
	...
	private void writeLabelFormatSheet(WritableSheet s1) throws WriteException {
		...
		WritableFont arial10ptUnderline = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
		...
		WritableFont arial10ptDoubleUnderline = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
		...
		WritableFont arial10ptSingleAcc = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
		...
		WritableFont arial10ptDoubleAcc = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
		...
		WritableFont arial18ptBoldItalicUnderline = new WritableFont(WritableFont.ARIAL, 18, WritableFont.BOLD, true,
				UnderlineStyle.SINGLE);
		...
		WritableFont superscript = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
				UnderlineStyle.NO_UNDERLINE, Colour.BLACK, ScriptStyle.SUPERSCRIPT);
		...
		WritableFont subscript = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
				UnderlineStyle.NO_UNDERLINE, Colour.BLACK, ScriptStyle.SUBSCRIPT);
		...
		WritableFont red = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
		...
		WritableFont blue = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
		...
		WritableFont yellow = new WritableFont(WritableFont.ARIAL, 10, WritableFont.NO_BOLD, false,
		...
		cellFeatures
				.setComment(
						"a very long cell comment indeed that won't fit inside a standard comment box, so a larger comment box is used instead",
						5.0D, 6.0D);
		...
		b = new Blank(1, 64);
		cellFeatures = new WritableCellFeatures();
		cellFeatures.setNumberValidation(4.5D, WritableCellFeatures.GREATER_THAN);
		b.setCellFeatures(cellFeatures);
		s1.addCell(b);
	...
	private void writeFormulaSheet(WritableSheet ws) throws WriteException {
		...
		nc = new Number(0, 1, 16.0D);
		ws.addCell(nc);

		nc = new Number(0, 2, 10.0D);
		ws.addCell(nc);

		nc = new Number(0, 3, 12.0D);
		ws.addCell(nc);
	...
	private void writeImageSheet(WritableSheet ws) throws WriteException {
		...
		wi = new WritableImage(5.0D, 12.0D, 4.0D, 10.0D, new File("resources/merchantadventurers.png"));
