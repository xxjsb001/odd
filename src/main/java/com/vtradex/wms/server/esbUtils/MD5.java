...
/**
 * Created by IntelliJ IDEA. Title:MD5通用加密类 User: YeRenBin Mail:Org114@163.com
 * Tel:86-028-81255754 Date: 2006-3-15 Time: 22:59:24 To change this template
...
public class MD5 {
	...
	/*
	 * F, G, H ,I 是4个基本的MD5函数.把它们 实现成了private方法，名字保持了原来C中的。
	 */
	...
	public static void main(
		...
		if (Array.getLength(args) == 0) { // 如果没有参数，执行默认的Test
			...
			System.out
					.println("MD5(\"jjjjjjjj\"):" + m.getMD5ofStr("jjjjjjjj"));
